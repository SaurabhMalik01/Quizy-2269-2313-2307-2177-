...
const MCQ = ({ game }: Props) => {
  ...
  const handleNext = React.useCallback(() => {
    ...
    setFeedback(null);
  }, [checkAnswer, currentQuestion.answer, game.questions.length, hasSubmitted, options, questionIndex, toast, endGame, selectedChoice]);
    ...
    <div className="absolute -translate-x-1/2 -translate-y-1/2 md:w-[80vw] max-w-4xl w-[90vw] top-1/2 left-1/2">
      ...
      <div className="flex flex-col items-center justify-center w-full mt-4">
        {options.map((option, index) => {
          ...
          const isSelectedOption = selectedChoice === index;
          const optionClasses = hasSubmitted
            ? isCorrectOption
          ...
          return (
            <Button
              ...
              className={`justify-start w-full py-8 mb-4 ${optionClasses}`}
